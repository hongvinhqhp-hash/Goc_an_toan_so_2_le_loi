...
# --- 2. TRANG TRÍ GIAO DIỆN BẰNG CSS (CỠ CHỮ CHUẨN NHƯ PHIÊN BẢN ĐẦU) ---
st.markdown("""
<style>
    ...
    /* TOÀN BỘ CHỮ VĂN BẢN - Kích thước chuẩn (17px), nét vừa phải, dễ đọc */
    ...
    /* NÚT BẤM (BUTTON) - Gọn gàng, bo góc */
    .stButton>button {
