...
# --- 2. TRANG TRÍ GIAO DIỆN BẰNG CSS (UI/UX CHUYÊN NGHIỆP) ---
st.markdown("""
<style>
    ...
    /* Tiêu đề chính (H1) - Lớn tối đa, đậm nét và nổi bật */
    ...
    /* Tiêu đề phụ (H2, H3) - To và rõ ràng */
    .main h2, .main h3 { 
    ...
    /* TOÀN BỘ CHỮ VĂN BẢN NỘI DUNG - TO, ĐẬM, ĐEN TUYỀN */
    ...
    /* Tiêu đề "Danh Mục Chính" thu gọn vừa 1 dòng */
    ...
    /* Chữ trong menu nhỏ gọn để không bị rớt dòng */
    [data-testid="stSidebar"] p, [data-testid="stSidebar"] span, [data-testid="stSidebar"] label {
        font-size: 16px !important; 
        font-weight: 700 !important;
    }

    /* NÚT BẤM (BUTTON) - LỚN, ĐỎ NỔI BẬT VÀ BO GÓC */
    .stButton>button {
