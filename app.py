...
# --- 2. TRANG TRÍ GIAO DIỆN BẰNG CSS (CHỮ NỘI DUNG SIÊU LỚN - RESPONSIVE) ---
st.markdown("""
<style>
    ...
    /* TOÀN BỘ CHỮ VĂN BẢN CẤP THẤP (Đoạn văn, danh sách, nhãn dán, câu hỏi) - TĂNG RẤT MẠNH */
    .main p, .main li, .main span, .main label, div.stMarkdown, .stTextArea textarea, .stSelectbox div {
        font-size: clamp(22px, 3.5vw, 28px) !important; /* Tối thiểu 22px (rất to trên đt), tối đa 28px */
    ...
    /* Chữ chức năng ở Menu - Phóng to lên 22px để dễ bấm */
...
if menu == "📖 Cẩm nang Kỹ năng":
    ...
    st.success("💡 **Quy tắc ứng bản 3K:** KHÔNG im lặng - KHÔNG cổ vũ - KỊP THỜI báo cáo")
